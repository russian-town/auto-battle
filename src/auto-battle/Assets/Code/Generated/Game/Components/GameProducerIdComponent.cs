...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Effect.ProducerId producerId { get { return (Code.Gameplay.Features.Effect.ProducerId)GetComponent(GameComponentsLookup.ProducerId); } }
    ...
    public GameEntity AddProducerId(int newValue) {
        ...
        var component = (Code.Gameplay.Features.Effect.ProducerId)CreateComponent(index, typeof(Code.Gameplay.Features.Effect.ProducerId));
