...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Fighter.Damage damage { get { return (Code.Gameplay.Features.Fighter.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Fighter.Damage)CreateComponent(index, typeof(Code.Gameplay.Features.Fighter.Damage));
