...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Effect.EffectValue effectValue { get { return (Code.Gameplay.Features.Effect.EffectValue)GetComponent(GameComponentsLookup.EffectValue); } }
    ...
    public GameEntity AddEffectValue(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Effect.EffectValue)CreateComponent(index, typeof(Code.Gameplay.Features.Effect.EffectValue));
