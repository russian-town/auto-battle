...
public partial class Contexts {
    ...
    public const string ParentAnimationId = "ParentAnimationId";
    ...
    public void InitializeEntityIndices() {
        ...
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            ParentAnimationId,
            game.GetGroup(GameMatcher.ParentAnimationId),
            (e, c) => ((Code.Gameplay.Features.Animations.ParentAnimationId)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithParentAnimationId(this GameContext context, int Value) {
        return ((Entitas.EntityIndex<GameEntity, int>)context.GetEntityIndex(Contexts.ParentAnimationId)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
